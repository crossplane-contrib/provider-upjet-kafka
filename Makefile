...
export TERRAFORM_PROVIDER_REPO ?= https://github.com/Mongey/terraform-provider-kafka
export TERRAFORM_PROVIDER_VERSION ?= 0.5.4
...
# Inherited from build submodule
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/kafkas/01-delete.yaml.tmpl.
