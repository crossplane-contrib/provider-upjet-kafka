...
func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for Kafka").DefaultEnvars()
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Kafka controllers")
